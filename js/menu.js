...
document.getElementById('nav').querySelector('ul.dropdown').insertAdjacentHTML("beforebegin", "<span id='menutoggle' class='test'><span></span></span>");
...
function hideMenu() {
    var el = document.querySelectorAll("#menutoggle, #menutoggle + ul, #nav span.submenu, #nav span.submenu li, #nav ul.submenu");
    var i;
    for (i = 0; i < el.length; i++) {
        el[i].classList.remove(activeClass);
    }
